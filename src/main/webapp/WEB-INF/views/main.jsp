...
<div class="app index" data-app>
    ...
    <ul class="feed-list">
        ...
        <li>
            ...
            <a href="./intro?idx=${item.idx}">
                <div class="item-header">
                    <c:if test='${item.amenu == "자아탐구"}'>
                    ...
                    <c:if test='${item.amenu == "연애"}'>
                    <img src="https://cdn.banggooso.com/assets/images/category-icons/category-heart.png" class="item-icon">
                    <span class="category-title">연애 · 심리</span>
                    </c:if>
                    <c:if test='${item.amenu == "초능력"}'>
                    <img src="https://cdn.banggooso.com/assets/images/category-icons/category-power.png" class="item-icon">
                    <span class="category-title">초능력</span>
                    </c:if>
                    <c:if test='${item.amenu == "타임킬러"}'>
                    <img src="https://cdn.banggooso.com/assets/images/category-icons/category-clock.png" class="item-icon">
                    <span class="category-title">타임킬러</span>
                    </c:if>
                </div>

                <figure class="thumb">
                    <div class="feed_thum_icon_box">
                        <c:if test="${item.anew == '1'}">
                    ...
                    <img src="/_admin/uploads/assets/images/uploadImg/${item.afile_regName}"  alt="">
                </figure>
                <div class="item-body">
                    <div class="title_wrap">
                        <h4 class="title">${item.atitle}</h4>
                        <h5 class="s_title">${item.asubtitle}</h5>
                    </div>
...
<script>
    ...
    function wave_slide_box() {
        let index = 0;
        let index_last = $('.home-feed .recommend-list .swiper-slide').length;
        console.log(index_last);

        let inter_li = setInterval(() => {

            $('.home-feed .recommend-list .swiper-slide').eq(index).addClass('wave_idx');
            index++;
            //console.log(index);
            if (index === index_last) {
                index = 0;
            }
            $('.home-feed .recommend-list .swiper-slide').eq(index).removeClass('wave_idx');
        }, 1000);
    }
